      ...
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        @else
                          <ul class="nav nav-treeview">
                            @foreach ($menu_item['children'] ?? [] as $menu_subitem)
                              <li class="nav-item">
                                <a href="/{{ $module_env['ROUTE_PREFIX'] }}{{ $menu['path'] }}{{ $menu_item['path'] }}{{ $menu_subitem['path'] }}"
                                  class="nav-link">
        ...
        @if (false)
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ $module_env['ROUTE_PREFIX'] }}/index" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Dashboard v1</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ $module_env['ROUTE_PREFIX'] }}/index2" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Dashboard v2</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ $module_env['ROUTE_PREFIX'] }}/index3" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Dashboard v3</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            <a href="{{ $module_env['ROUTE_PREFIX'] }}/pages/widgets.html" class="nav-link">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ $module_env['ROUTE_PREFIX'] }}/pages/layout/top-nav.html" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Top Navigation</p>
                </a>
              </li>
