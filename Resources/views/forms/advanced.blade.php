...
<head>
  ...
  <link rel="stylesheet" href="/modules/adminlte/public/vendor/bootstrap-colorpicker/css/bootstrap-colorpicker.min.css">
  <!-- Tempusdominus Bootstrap 4 -->
  <link rel="stylesheet"
    href="/modules/adminlte/public/vendor/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css">
  <!-- Select2 -->
  <link rel="stylesheet" href="/modules/adminlte/public/vendor/select2/css/select2.min.css">
  <link rel="stylesheet" href="/modules/adminlte/public/vendor/select2-bootstrap4-theme/select2-bootstrap4.min.css">
  <!-- Bootstrap4 Duallistbox -->
  <link rel="stylesheet" href="/modules/adminlte/public/vendor/bootstrap4-duallistbox/bootstrap-duallistbox.min.css">
  <!-- BS Stepper -->
  <link rel="stylesheet" href="/modules/adminlte/public/vendor/bs-stepper/css/bs-stepper.min.css">
  <!-- dropzonejs -->
  <link rel="stylesheet" href="/modules/adminlte/public/vendor/dropzone/min/dropzone.min.css">
  <!-- Theme style -->
...
<body class="hold-transition sidebar-mini">
  <div class="wrapper">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
            <a href="#" class="dropdown-item">
              <!-- Message Start -->
              <div class="media">
                <img src="/modules/adminlte/public/img/user1-128x128.jpg" alt="User Avatar"
            ...
            <a href="#" class="dropdown-item">
              <!-- Message Start -->
              <div class="media">
                <img src="/modules/adminlte/public/img/user8-128x128.jpg" alt="User Avatar"
            ...
            <a href="#" class="dropdown-item">
              <!-- Message Start -->
              <div class="media">
                <img src="/modules/adminlte/public/img/user3-128x128.jpg" alt="User Avatar"
                  class="img-size-50 img-circle mr-3">
                <div class="media-body">
                  <h3 class="dropdown-item-title">
                    Nora Silvester
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="../../index3.html" class="brand-link">
        <img src="/modules/adminlte/public/img/AdminLTELogo.png" alt="AdminLTE Logo"
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          <div class="image">
            <img src="/modules/adminlte/public/img/user2-160x160.jpg" class="img-circle elevation-2"
              alt="User Image">
          </div>
          <div class="info">
  ...
  <!-- Select2 -->
  <script src="/modules/adminlte/public/vendor/select2/js/select2.full.min.js"></script>
  <!-- Bootstrap4 Duallistbox -->
  <script src="/modules/adminlte/public/vendor/bootstrap4-duallistbox/jquery.bootstrap-duallistbox.min.js"></script>
  <!-- InputMask -->
  <script src="/modules/adminlte/public/vendor/moment/moment.min.js"></script>
  <script src="/modules/adminlte/public/vendor/inputmask/jquery.inputmask.min.js"></script>
  <!-- date-range-picker -->
  <script src="/modules/adminlte/public/vendor/daterangepicker/daterangepicker.js"></script>
  <!-- bootstrap color picker -->
  <script src="/modules/adminlte/public/vendor/bootstrap-colorpicker/js/bootstrap-colorpicker.min.js"></script>
  <!-- Tempusdominus Bootstrap 4 -->
  <script src="/modules/adminlte/public/vendor/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.min.js"></script>
  <!-- Bootstrap Switch -->
  <script src="/modules/adminlte/public/vendor/bootstrap-switch/js/bootstrap-switch.min.js"></script>
  <!-- BS-Stepper -->
  <script src="/modules/adminlte/public/vendor/bs-stepper/js/bs-stepper.min.js"></script>
  <!-- dropzonejs -->
  <script src="/modules/adminlte/public/vendor/dropzone/min/dropzone.min.js"></script>
  <!-- AdminLTE App -->
