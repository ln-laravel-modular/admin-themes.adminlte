...
<head>
  ...
  <!-- SweetAlert2 -->
  <link rel="stylesheet" href="/modules/adminlte/public/vendor/sweetalert2-theme-bootstrap-4/bootstrap-4.min.css">
  <!-- Toastr -->
...
<body class="hold-transition sidebar-mini">
  ...
  <!-- SweetAlert2 -->
  <script src="/modules/adminlte/public/vendor/sweetalert2/sweetalert2.min.js"></script>
  <!-- Toastr -->
  <script src="/modules/adminlte/public/vendor/toastr/toastr.min.js"></script>
  <!-- AdminLTE App -->
    ...
    $(function() {
      ...
      $('.toastsDefaultFullImage').click(function() {
        $(document).Toasts('create', {
          ...
          title: 'Toast Title',
          subtitle: 'Subtitle',
          image: '/modules/adminlte/public/img/user3-128x128.jpg',
