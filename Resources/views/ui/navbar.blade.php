...
<head>
  ...
  <!-- SweetAlert2 -->
  <link rel="stylesheet" href="/modules/adminlte/public/vendor/sweetalert2/sweetalert2.min.css">
  <!-- Toastr -->
  <link rel="stylesheet" href="/modules/adminlte/public/vendor/toastr/toastr.min.css">
  <!-- Theme style -->
                    ...
                    <div class="col-12 col-lg-6">
                      ...
                      <nav class="navbar navbar-expand navbar-light">
                        ...
                        <ul class="navbar-nav ml-auto">
                          <!-- Navbar Search -->
                          <li class="nav-item">
                            <a class="nav-link" data-widget="navbar-search" data-target="#navbar-search1"
                              href="#" role="button">
                              <i class="fas fa-search"></i>
                            </a>
                    ...
                    <div class="col-12 col-lg-6">
                      ...
                      <nav class="navbar navbar-expand navbar-white navbar-light">
                        ...
                        <ul class="navbar-nav ml-auto">
                          <!-- Navbar Search -->
                          <li class="nav-item">
                            <a class="nav-link" data-widget="navbar-search" data-target="#navbar-search2"
                              href="#" role="button">
                              <i class="fas fa-search"></i>
                            </a>
                    ...
                    <div class="col-12 col-lg-6">
                      ...
                      <nav class="navbar navbar-expand navbar-primary navbar-dark">
                        ...
                        <ul class="navbar-nav ml-auto">
                          <!-- Navbar Search -->
                          <li class="nav-item">
                            <a class="nav-link" data-widget="navbar-search" data-target="#navbar-search3"
                              href="#" role="button">
                              <i class="fas fa-search"></i>
                            </a>
                    ...
                    <div class="col-12 col-lg-6">
                      ...
                      <nav class="navbar navbar-expand navbar-primary navbar-light">
                        ...
                        <ul class="navbar-nav ml-auto">
                          <!-- Navbar Search -->
                          <li class="nav-item">
                            <a class="nav-link" data-widget="navbar-search" data-target="#navbar-search4"
                              href="#" role="button">
                              <i class="fas fa-search"></i>
                            </a>
                    ...
                    <div class="col-12 col-lg-6">
                      ...
                      <nav class="navbar navbar-expand navbar-orange navbar-light">
                        ...
                        <ul class="navbar-nav ml-auto">
                          <!-- Navbar Search -->
                          <li class="nav-item">
                            <a class="nav-link" data-widget="navbar-search" data-target="#navbar-search5"
                              href="#" role="button">
                              <i class="fas fa-search"></i>
                            </a>
                    ...
                    <div class="col-12 col-lg-6">
                      ...
                      <nav class="navbar navbar-expand navbar-orange navbar-dark">
                        ...
                        <ul class="navbar-nav ml-auto">
                          <!-- Navbar Search -->
                          <li class="nav-item">
                            <a class="nav-link" data-widget="navbar-search" data-target="#navbar-search6"
                              href="#" role="button">
                              <i class="fas fa-search"></i>
                            </a>
                  ...
                  <ul class="nav nav-tabs" id="custom-tabs-five-tab" role="tablist">
                    ...
                    <li class="nav-item">
                      <a class="nav-link" id="custom-tabs-five-overlay-dark-tab" data-toggle="pill"
                        ...
                        aria-controls="custom-tabs-five-overlay-dark" aria-selected="false">Overlay Dark</a>
                    </li>
                    <li class="nav-item">
